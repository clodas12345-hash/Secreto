...
// I'm going to find the whole `{activeFolderId !== null && (` block and rewrite it cleanly.
const startIndex = content.indexOf('{activeFolderId !== null && (');
const endIndex = content.indexOf('{activeTab === \'settings\' && (');

if (startIndex !== -1 && endIndex !== -1) {
  const newBlock = `{activeFolderId !== null && (
              <>
